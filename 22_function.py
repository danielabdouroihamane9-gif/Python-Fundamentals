...
print(
    display_info(age=25, name="Diana")
...
def print_kwargs(**kwargs):
    ...
    for (
        key,
        value,
    ) in kwargs.items():  # display the key-value pairs of the kwargs dictionary
...
display_info(
    1, 2, 3, name="Frank", age=35
)  # Output: Positional arguments: 1, 2, 3; Keyword arguments: name: Frank, age: 35
